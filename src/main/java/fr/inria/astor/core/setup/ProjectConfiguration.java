...
public class ProjectConfiguration {
    ...
    public String getProflMethodFilepath() {
        return (String) this.internalProperties.get(ProjectPropertiesEnum.proflMethodPath);
    }

    public String getProflTestCoverageFilepath() {
        return (String) this.internalProperties.get(ProjectPropertiesEnum.proflTestPath);
    }

    public String getProflFailingTestFilepath() {
        return (String) this.internalProperties.get(ProjectPropertiesEnum.proflFailingTestPath);
    }
