...
public abstract class AbstractMain {
    ...
    static {
        ...
        options.addOption("buggyMethod", true, "Path to buggyMethod file");
    ...
    public boolean processArguments(String[] args) throws Exception {
        ...
        if (cmd.hasOption("buggyMethod")) {
            System.out.println("Buggy method detected: " + cmd.getOptionValue("buggyMethod"));
            ConfigurationProperties.properties.setProperty("buggyMethod", cmd.getOptionValue("buggyMethod"));
        }
    ...
    protected ProjectRepairFacade getProjectConfiguration(String location, String projectIdentifier, String method,
        ...
        properties.setProperty(ProjectPropertiesEnum.buggyMethods, ConfigurationProperties.getProperty("buggyMethod"));
