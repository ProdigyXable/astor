 ...
 *
 */
public class CardumenApproach_Profl extends CardumenApproach {
    ...
    public CardumenApproach_Profl(MutationSupporter mutatorExecutor, ProjectRepairFacade projFacade) throws JSAPException, Exception {
        ...
        log.info(String.format("Creating Profl-based cardumen %s, %s, %s", proflMethod, proflTest, proflFailing));
    }

    @Override
    public VariantValidationResult validateInstance(ProgramVariant variant) {
        JUnitProcessValidator.patchNum += 1;
